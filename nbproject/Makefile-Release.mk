...
${OBJECTDIR}/model/PlayedVideo.o: model/PlayedVideo.cpp
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/PlayedVideo.o model/PlayedVideo.cpp
...
${OBJECTDIR}/player/MinimalTrackSelector.o: player/MinimalTrackSelector.cpp
	${MKDIR} -p ${OBJECTDIR}/player
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/player/MinimalTrackSelector.o player/MinimalTrackSelector.cpp
